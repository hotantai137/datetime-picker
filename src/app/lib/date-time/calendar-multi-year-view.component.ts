...
@Component({
    selector: 'h2t-date-time-multi-year-view',
    templateUrl: './calendar-multi-year-view.component.html',
    styleUrls: ['./calendar-multi-year-view.component.scss'],
    host:{
        '[class.h2t-dt-calendar-view]': 'h2tDTCalendarView',
        '[class.h2t-dt-calendar-multi-year-view]': 'h2tDTCalendarMultiYearView'
    },
    preserveWhitespaces: false,
    changeDetection: ChangeDetectionStrategy.OnPush,
})

export class H2TMultiYearViewComponent<T> implements OnInit, AfterContentInit {
    ...
    @ViewChild(H2TCalendarBodyComponent, { static: true }) calendarBodyElm: H2TCalendarBodyComponent;

    get h2tDTCalendarView(): boolean {
        return true;
    }

    get h2tDTCalendarMultiYearView(): boolean {
        return true;
    }
    ...
    private createYearCell( year: number ): CalendarCell {
        ...
        const cellClass = 'h2t-dt-year-' + year;
