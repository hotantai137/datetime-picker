...
@Component({
    exportAs: 'h2tDateTimeTimerBox',
    selector: 'h2t-date-time-timer-box',
    templateUrl: './timer-box.component.html',
    styleUrls: ['./timer-box.component.scss'],
    preserveWhitespaces: false,
    changeDetection: ChangeDetectionStrategy.OnPush,
    host: {
        '[class.h2t-dt-timer-box]': 'h2tDTTimerBoxClass'
    }
})

export class H2TTimerBoxComponent implements OnInit, OnDestroy {
    ...
    get h2tDTTimerBoxClass(): boolean {
        return true;
    }
