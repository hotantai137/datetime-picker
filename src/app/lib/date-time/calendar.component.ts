...
@Component({
    selector: 'h2t-date-time-calendar',
    exportAs: 'h2tDateTimeCalendar',
    templateUrl: './calendar.component.html',
    styleUrls: ['./calendar.component.scss'],
    host: {
        '[class.h2t-dt-calendar]': 'h2tDTCalendarClass'
    },
    preserveWhitespaces: false,
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class H2TCalendarComponent<T>
    ...
    get periodButtonText(): string {
        if(this.isMonthView){
            return this.dateTimeAdapter.getYearMonthJP(this.pickerMoment);            
        }else{
    ...
    /**
     * Bind class 'h2t-dt-calendar' to host
     * */
    get h2tDTCalendarClass(): boolean {
        return true;
    }
    ...
    constructor(
        ...
        private dateTimeFormats: H2TDateTimeFormats
    ) {
            ...
            this.ngZone.onStable
                ...
                .subscribe(() => {
                    this.elmRef.nativeElement
                        .querySelector('.h2t-dt-calendar-cell-active')
                        .focus();
                });
        });
    }
