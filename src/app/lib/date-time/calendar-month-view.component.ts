...
@Component({
    selector: 'h2t-date-time-month-view',
    exportAs: 'h2tYearView',
...
export class H2TMonthViewComponent<T>
    ...
    @ViewChild(H2TCalendarBodyComponent, { static: true })
    calendarBodyElm: H2TCalendarBodyComponent;
    ...
    private createDateCell(date: T, daysDiff: number): CalendarCell {
        ...
        const cellClass = 'h2t-dt-day-' + this.dateTimeAdapter.getDay(date);
