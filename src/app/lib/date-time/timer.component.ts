...
@Component({
    exportAs: 'h2tDateTimeTimer',
    selector: 'h2t-date-time-timer',
    templateUrl: './timer.component.html',
    styleUrls: ['./timer.component.scss'],
    preserveWhitespaces: false,
    changeDetection: ChangeDetectionStrategy.OnPush,
    host: {
        '[class.h2t-dt-timer]': 'h2tDTTimerClass',
        '[attr.tabindex]': 'h2tDTTimeTabIndex'
    }
})
export class H2TTimerComponent<T> implements OnInit {
    ...
    get h2tDTTimerClass(): boolean {
        return true;
    }

    get h2tDTTimeTabIndex(): number {
        return -1;
    }
