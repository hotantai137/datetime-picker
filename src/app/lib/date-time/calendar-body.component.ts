...
@Component({
    selector: '[h2t-date-time-calendar-body]',
    exportAs: 'h2tDateTimeCalendarBody',
    templateUrl: './calendar-body.component.html',
    styleUrls: ['./calendar-body.component.scss'],
    host:{
        '[class.h2t-dt-calendar-body]': 'h2tDTCalendarBodyClass'
    },
    preserveWhitespaces: false,
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class H2TCalendarBodyComponent implements OnInit {
    /**
    ...
    get h2tDTCalendarBodyClass(): boolean {
        return true;
    }
