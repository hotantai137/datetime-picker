...
describe('H2TMonthViewComponent', () => {
    beforeEach(async(() => {
    ...
    describe('standard month view', () => {
        ...
        let monthViewInstance: H2TMonthViewComponent<Date>;
...
@Component({
    template: `
        <h2t-date-time-month-view
                [(selected)]="selected"
                [(pickerMoment)]="pickerMoment"></h2t-date-time-month-view>
    `
})
...
@Component({
    template: `
        <h2t-date-time-month-view
                ...
                [dateFilter]="dateFilter"></h2t-date-time-month-view>
    `
})
