...
import { H2T_DATE_TIME_FORMATS } from './adapter/date-time-format.class';
...
describe('H2TDateTimeComponent', () => {
    ...
    describe('with H2TNativeDateTimeModule', () => {
        describe('standard DateTimePicker', () => {
            ...
            it('should open popup when pickerMode is "popup"', () => {
                expect(
                    document.querySelector('.cdk-overlay-pane.h2t-dt-popup')
                ).toBeNull();
            ...
            it('should open dialog when pickerMode is "dialog"', () => {
                ...
                expect(
                    document.querySelector(
                        '.h2t-dt-dialog h2t-dialog-container'
                    )
                ).toBeNull();
            ...
            it('should open dateTimePicker if opened input is set to true', fakeAsync(() => {
                ...
                expect(
                    document.querySelector('.h2t-dt-container')
                ).not.toBeNull();
                ...
                expect(document.querySelector('.h2t-dt-container')).toBeNull();
            }));
            ...
            it('should NOT open dateTimePicker if it is disabled', () => {
                ...
                expect(
                    document.querySelector('h2t-date-time-container')
                ).toBeNull();
            ...
            it('should close dialog when fn close is called', fakeAsync(() => {
                ...
                expect(
                    document.querySelector('h2t-dialog-container')
                ).not.toBeNull();
            ...
            it('input should aria-owns h2t-date-time-container after opened in popup mode', fakeAsync(() => {
                ...
                expect((ownedElement as Element).tagName.toLowerCase()).toBe(
                    'h2t-date-time-container'
                );
            }));

            it('input should aria-owns h2t-date-time-container after opened in dialog mode', fakeAsync(() => {
                testComponent.pickerMode = 'dialog';
                fixture.detectChanges();
            ...
            describe('set to year', () => {
                ...
                it('should start at the year view', () => {
                    ...
                    let yearTable = containerElement.querySelector(
                        'table.h2t-dt-calendar-year-table'
                    );
            ...
            describe('set to multi-years', () => {
                ...
                it('should start at the multi-years view', () => {
                    ...
                    let multiYearTable = containerElement.querySelector(
                        'table.h2t-dt-calendar-multi-year-table'
                    );
        ...
        describe('DateTimePicker with h2tDateTimeTrigger', () => {
            ...
            it('should not open the picker when trigger clicked if dateTimePicker is disabled', () => {
                ...
                expect(toggle.classList).toContain('h2t-dt-trigger-disabled');
                expect(
                    document.querySelector('h2t-date-time-container')
                ).toBeNull();
    ...
    describe('with missing DateTimeAdapter and H2T_DATE_TIME_FORMATS', () => {
        it('should throw when created', () => {
            expect(() => createComponent(StandardDateTimePicker)).toThrowError(
                /H2TDateTimePicker: No provider found for .*/
            );
        });
    });
});
...
@Component({
    template: `
        <input [h2tDateTime]="dt" [value]="date">
        <h2t-date-time [opened]="opened"
                       [disabled]="disabled"
                       [pickerType]="pickerType"
                       [pickerMode]="pickerMode" #dt></h2t-date-time>
    `
})
class StandardDateTimePicker {
    ...
    dateTimePicker: H2TDateTimeComponent<Date>;
    @ViewChild(H2TDateTimeInputDirective, { static: true })
    dateTimePickerInput: H2TDateTimeInputDirective<Date>;
}

@Component({
    template: `
        <input [h2tDateTime]="dt" [selectMode]="selectMode" [values]="dates">
        <h2t-date-time [startAt]="startAt"
                       [pickerType]="pickerType" #dt></h2t-date-time>
    `
})
...
@Component({
    template: `
        <input [h2tDateTime]="dt">
        <input [h2tDateTime]="dt">
        <h2t-date-time #dt></h2t-date-time>
    `
})
...
@Component({
    template: `
        <input [h2tDateTime]="dt" [value]="date">
        <h2t-date-time #dt [startAt]="startDate"></h2t-date-time>
    `
})
...
@Component({
    template: `
        <input [h2tDateTime]="dt" [value]="date">
        <h2t-date-time #dt [startView]="startView"
                       (monthSelected)="onMonthSelection()"
                       (yearSelected)="onYearSelection()"></h2t-date-time>
    `
})
...
@Component({
    template: `
        <input [(ngModel)]="moment" [selectMode]="selectMode" [h2tDateTime]="dt">
        <h2t-date-time #dt></h2t-date-time>
    `
})
...
class DateTimePickerWithFormControl {
    ...
    @ViewChild(H2TDateTimeInputDirective, { static: true })
    dateTimePickerInput: H2TDateTimeInputDirective<Date>;
    @ViewChild(H2TDateTimeTriggerDirective, { static: true })
    dateTimePickerToggle: H2TDateTimeTriggerDirective<Date>;
}

@Component({
    template: `
        <input [h2tDateTime]="dt">
        <button [h2tDateTimeTrigger]="dt">Icon</button>
        <h2t-date-time #dt></h2t-date-time>
    `
})
...
@Component({
    template: `
        <input [(ngModel)]="date" [min]="min" [max]="max"
               [h2tDateTime]="dt"
               [h2tDateTimeTrigger]="dt">
        <h2t-date-time [showSecondsTimer]="true" #dt></h2t-date-time>
    `
})
...
@Component({
    template: `
    <input [h2tDateTime]="dt" [(ngModel)]="value" [min]="min" [max]="max">
    <h2t-date-time #dt [startAt]="startAt"></h2t-date-time>
  `
})
...
@Component({
    template: `
    <input [(ngModel)]="selected" [h2tDateTime]="dt">
    <h2t-date-time (afterPickerOpen)="openedSpy()" (afterPickerClosed)="closedSpy()" #dt></h2t-date-time>
  `
})
