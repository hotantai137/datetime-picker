...
describe('H2TTimerComponent', () => {
    ...
    describe('standard timer', () => {
        ...
        let timerInstance: H2TTimerComponent<Date>;
        ...
        beforeEach(() => {
            ...
            timerDebugElement = fixture.debugElement.query(
                By.directive(H2TTimerComponent)
            );
        ...
        it('should NOT have the hour12 toggle button if hour12Timer set to false', () => {
            let toggleBtn = timerElement.querySelector(
                'button.h2t-dt-timer-hour12-box'
            );
        ...
        it('should dispatch an event when a timer arrow button clicked', fakeAsync(() => {
            ...
            let arrowBtns = timerElement.querySelectorAll<HTMLButtonElement>(
                'button.h2t-dt-control-arrow-button'
            );
...
@Component({
    template: `
        <h2t-date-time-timer
                ...
                (selectedChange)="handleSelectedChange($event)"></h2t-date-time-timer>
    `
})
class StandardTimer {
    stepHour = 1;
