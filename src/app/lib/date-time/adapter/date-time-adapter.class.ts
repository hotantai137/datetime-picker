...
export const H2T_DATE_TIME_LOCALE = new InjectionToken<string>(
    'H2T_DATE_TIME_LOCALE',
    {
        providedIn: 'root',
        factory: H2T_DATE_TIME_LOCALE_FACTORY
    }
);

/** @docs-private */
export function H2T_DATE_TIME_LOCALE_FACTORY(): string {
    return inject(LOCALE_ID);
}

/** Provider for H2T_DATE_TIME_LOCALE injection token. */
export const H2T_DATE_TIME_LOCALE_PROVIDER = {
    provide: H2T_DATE_TIME_LOCALE,
...
export abstract class DateTimeAdapter<T> {
     ...
     * Gets the name for the year of the given date.
     */
     abstract getYearMonthJP(date: T): string;
