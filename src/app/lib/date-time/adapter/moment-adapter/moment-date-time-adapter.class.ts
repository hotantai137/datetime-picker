...
// import { DateTimeAdapter, H2T_DATE_TIME_LOCALE } from 'ng-pick-datetime';
...
export interface H2TMomentDateTimeAdapterOptions {
    /**
...
export const H2T_MOMENT_DATE_TIME_ADAPTER_OPTIONS = new InjectionToken<H2TMomentDateTimeAdapterOptions>(
    'H2T_MOMENT_DATE_TIME_ADAPTER_OPTIONS', {
        providedIn: 'root',
        factory: H2T_MOMENT_DATE_TIME_ADAPTER_OPTIONS_FACTORY
    });

/** @docs-private */
export function H2T_MOMENT_DATE_TIME_ADAPTER_OPTIONS_FACTORY(): H2TMomentDateTimeAdapterOptions {
    return {
        useUtc: false
    };
}
...
export class MomentDateTimeAdapter extends DateTimeAdapter<Moment> {
    ...
    constructor( @Optional() @Inject(H2T_DATE_TIME_LOCALE) private h2tDateTimeLocale: string,
                 @Optional() @Inject(H2T_MOMENT_DATE_TIME_ADAPTER_OPTIONS) private options?: H2TMomentDateTimeAdapterOptions ) {
        super();
        this.setLocale(h2tDateTimeLocale || moment.locale());
    }
    ...
    public getYearMonthJP( date: Moment ): string {
        const dateClone = this.clone(date);
        return dateClone.format('YYYY') + '年' + dateClone.format('MM') + '月';
    }
