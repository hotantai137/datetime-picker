...
describe('H2TCalendarComponent', () => {
    ...
    describe('standard calendar', () => {
        ...
        let calendarInstance: H2TCalendarComponent<Date>;
        ...
        beforeEach(() => {
            ...
            let calendarDebugElement = fixture.debugElement.query(
                By.directive(H2TCalendarComponent)
            );
            calendarElement = calendarDebugElement.nativeElement;

            periodButton = calendarElement.querySelector(
                '.h2t-dt-control-period-button'
            ) as HTMLElement;
        ...
        it('should re-render when the i18n labels have changed', () => {
            inject([H2TDateTimeIntl], (intl: H2TDateTimeIntl) => {
    ...
    describe('calendar with min and max', () => {
        ...
        it('should re-render the month view when the minDate changes', () => {
            let monthViewDebugElm = fixture.debugElement.query(
                By.directive(H2TMonthViewComponent)
            );
        ...
        it('should re-render the multi-years view when the minDate changes', () => {
            ...
            let multiYearsViewDebugElm = fixture.debugElement.query(
                By.directive(H2TMultiYearViewComponent)
            );
...
@Component({
    template: `
        <h2t-date-time-calendar
                [(selected)]="selected"
                [selectMode]="selectMode"
                [pickerMoment]="pickerMoment"
                (monthSelected)="selectedMonth=$event"
                (yearSelected)="selectedYear=$event"></h2t-date-time-calendar>
    `
})
...
@Component({
    template: `
        <h2t-date-time-calendar [selectMode]="selectMode"
                                [pickerMoment]="pickerMoment"
                                [minDate]="minDate"
                                [maxDate]="maxDate"></h2t-date-time-calendar>
    `
})
...
@Component({
    template: `
        <h2t-date-time-calendar [(selected)]="selected"
                                [selectMode]="selectMode"
                                [pickerMoment]="pickerMoment"
                                [dateFilter]="dateFilter"></h2t-date-time-calendar>
    `
})
