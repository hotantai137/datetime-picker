...
export type DisplayMode = 'white' | 'dark';

@Injectable()
export abstract class H2TDateTime<T> {
    /**
    ...
    abstract get displayMode(): DisplayMode;
    ...
    constructor(
        ...
        if (!this.dateTimeAdapter) {
            throw Error(
                `H2TDateTimePicker: No provider found for DateTimeAdapter. You must import one of the following ` +
        ...
        this._id = `h2t-dt-picker-${nextUniqueId++}`;
    }
